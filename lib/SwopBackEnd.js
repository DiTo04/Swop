...
exports.getQuestions = function() {
	...
	var data = [
		{ id:q.questions[0].id, questions:q.questions[0].question },
		{ id:q.questions[1].id, questions:q.questions[1].question },
		{ id:q.questions[2].id, questions:q.questions[2].question },
		{ id:q.questions[3].id, questions:q.questions[3].question },
		{ id:q.questions[4].id, questions:q.questions[4].question },
		{ id:q.questions[5].id, questions:q.questions[5].question },
		{ id:q.questions[6].id, questions:q.questions[6].question },
		{ id:q.questions[7].id, questions:q.questions[7].question },
		{ id:q.questions[8].id, questions:q.questions[8].question },
		{ id:q.questions[9].id, questions:q.questions[9].question },
	]
	return data
}
